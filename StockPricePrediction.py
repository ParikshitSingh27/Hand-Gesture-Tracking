...
def predict_future_prices(model, data, future_days, scaler):
    sequence_length = 60
...
def main():
    file_paths = {
        1: 'Quote-Equity-ADANIPORTS-EQ-06-09-2023-to-06-09-2024.csv',
        2: 'Quote-Equity-TATAGLOBAL-EQ-06-09-2023-to-06-09-2024.csv',
        3: 'Quote-Equity-ZOMATO-EQ-06-09-2023-to-06-09-2024.csv'
    }
    while True:
